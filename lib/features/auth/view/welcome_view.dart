  ...
  Future<void> _handleSocialLogin(String provider) async {
    ...
    try {
      ...
      if (user != null && mounted) {
        ...
        if (mounted) {
          debugPrint(
              'WelcomeView: DIRECT navigation to ${isClient ? "ClientMainView" : "ProviderMainView"}');
          Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
              builder: (context) =>
                  isClient ? const ClientMainView() : const ProviderMainView(),
            ),
            (route) => false,
          );
        }
                      ...
                      Column(
                        children: [
                          ...
                          FadeInUp(
                            ...
                            duration: Duration(milliseconds: 1000),
                            child: Text(
                              AppLocalizations.of(context)!.yourReliablePartner,
                              style: TextStyle(
                                fontSize: 13,
